    ...
    <div className="bg-bg3 min-h-screen  flex flex-row justify-center items-center text-left">
      ...
      <div className="flex flex-row shadow-2xl justify-center  md:p-0 rounded-xl overflow-hidden mx-6 md:max-w-4xl  md:w-[53rem] md:h-[35rem] md:mx-0">
        ...
        <div className=" bg-white px-8 w-screen  py-4 rounded-2xl md:rounded-none md:w-[50%] md:px-10 md:py-2">
          <h1 className="text-text1 py-3 font-bold font-sans text-[1.9rem] text-left mb-[1.5rem]">
            Create Account
          </h1>
          {/* Form Container */}
          ...
          <button className="bg-blue1 text-white text-md mt-10 w-full p-3 rounded-md shadow-lg border-2 border-blue1  shadow-blue-300  hover:bg-white hover:text-blue1 hover:border-2 hover:border-blue1 hover:shadow-none duration-100 ">
            Create Account
          </button>
          <p className="text-text2 font-sans font-light text-xs text-center mt-8 mb-1">
