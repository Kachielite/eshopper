  ...
  return (
    ...
    <div className="flex flex-row px-1 md:px-6 py-5 items-center justify-between w-full h-16 bg-bg2">
      ...
      <div className="flex flex-row space-x-0 items-center">
        <div className="relative flex flex-row space-x-4 items-center h-6  py-2.5 px-2 border-l-2 border-r-2 border-bg3">
          {/* <img
            src={messageIcon}
            alt="message"
          ...
          <Transition
            ...
            onMouseLeave={() => showNotificationsHandler(false)}>
            <div className="flex flex-col space-y-0 p-0">
              <div class="w-full overflow-hidden flex flex-col items-end pr-16  md:pr-7">
                <div class=" h-3 w-3 bg-bg2 rotate-45 transform origin-bottom-left"></div>
              </div>
              <div className=" flex flex-col w-80 h-72  bg-bg2 space-y-0">
                <div className="flex flex-row justify-between items-center px-4 py-3.5 h-11 w-full">
                  <div className="flex flex-row space-x-2 items-center">
                    <p className="text-text1 font-normal text-base">
                      Notification
                    </p>
                  ...
                  <p className="text-text1 font-normal text-base cursor-pointer">
                    Clear All
                  </p>
                </div>
                <div className="group flex flex-row items-center w-full h-16 px-6 py-3 justify-between border-t-2 border-bgWhite topbar-activeMenu cursor-pointer">
                  <div className="flex flex-row space-x-5">
                    ...
                    <div>
                      ...
                      <p className="text-text2 font-normal text-xs ">
                        25 min ago
                      </p>
                    </div>
                  </div>
                  <div>
                    <img
                      ...
                      className="hidden group-hover:block group-hover:duration-150"
                    />
                  </div>
                </div>
                <div className="group flex flex-row items-center w-full h-16 px-6 py-3 justify-between border-t-2 border-bgWhite topbar-activeMenu cursor-pointer">
                ...
                <div className="flex flex-row justify-center items-center px-4 py-3.5 h-full w-full border-t-2 border-bgWhite topbar-activeMenu">
                  <div className="flex flex-row space-x-2 items-center">
                    <p className="text-text2 font-normal text-base">
        ...
        <div
          className="flex flex-row space-x-4 items-center  py-2.5 px-2 md:px-5 cursor-pointer"
          ...
          <div className="flex flex-row relative">
            ...
            <Transition
              ...
              <div className="flex flex-col space-y-0 p-0">
                ...
                <div className=" flex flex-col w-40 md:w-48  bg-bg2 space-y-1">
